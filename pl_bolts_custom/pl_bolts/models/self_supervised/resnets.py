...
def _resnet(arch, block, layers, pretrained, progress, fhdnn=True, **kwargs):
    model = ResNet(block, layers, fhdnn=fhdnn, **kwargs)
    if pretrained:
...
def resnet18(pretrained: bool = False, progress: bool = True, fhdnn=True, **kwargs):
    ...
    """
    return _resnet("resnet18", BasicBlock, [2, 2, 2, 2], pretrained, progress, fhdnn, **kwargs)
